...
This module provides authentication utilities including JWT token handling,
OAuth/OIDC integration, and role-based access control.
"""
...
from .security import SecretManager, HanaSecrets
...
# Import these models directly in the auth module to avoid circular imports
