...
This module provides enhanced logging capabilities including structured JSON logging,
function timing, and specialized loggers for API requests and search operations.
"""
